...
CREATE INDEX `fk_lord_deces_secondaire_lord_deces_principal1_idx` ON `lord`.`lord_death_causes_secondary` (`deces_principal_id` ASC);
...
CREATE INDEX `FK_origine_idx` ON `lord`.`lord_backoffice_rat_entries` (`rattery_mother_id` ASC);

CREATE INDEX `FK_pere_idx` ON `lord`.`lord_backoffice_rat_entries` (`rat_father_id` ASC);

CREATE INDEX `FK_mere_idx` ON `lord`.`lord_backoffice_rat_entries` (`rat_mother_id` ASC);

CREATE INDEX `Fk_proprietaire_idx` ON `lord`.`lord_backoffice_rat_entries` (`user_owner_id` ASC);

CREATE INDEX `FK_couleur_idx` ON `lord`.`lord_backoffice_rat_entries` (`color_id` ASC);

CREATE INDEX `FK_oreilles_idx` ON `lord`.`lord_backoffice_rat_entries` (`earset_id` ASC);

CREATE INDEX `FK_yeux_idx` ON `lord`.`lord_backoffice_rat_entries` (`eyecolor_id` ASC);

CREATE INDEX `fk_dilutions_idx` ON `lord`.`lord_backoffice_rat_entries` (`dilution_id` ASC);

CREATE INDEX `fk_poils_idx` ON `lord`.`lord_backoffice_rat_entries` (`coat_id` ASC);

CREATE INDEX `fk_marquage_idx` ON `lord`.`lord_backoffice_rat_entries` (`marking_id` ASC);

CREATE INDEX `FK_deces_idx` ON `lord`.`lord_backoffice_rat_entries` (`death_cause_primary_id` ASC);

CREATE INDEX `FK_enregistreur_idx` ON `lord`.`lord_backoffice_rat_entries` (`user_creator_id` ASC);

CREATE INDEX `fk_lord_rats_lord_raterie1_idx` ON `lord`.`lord_backoffice_rat_entries` (`rattery_father_id` ASC);

CREATE INDEX `fk_lord_rats_lord_deces_secondaire1_idx` ON `lord`.`lord_backoffice_rat_entries` (`death_cause_secondary_id` ASC);

CREATE INDEX `fk_lord_backoffice_rat_entries_lord_rats1_idx` ON `lord`.`lord_backoffice_rat_entries` (`rat_id` ASC);
...
CREATE INDEX `fk_lord_sav_lord_utilisateurs1_idx` ON `lord`.`lord_backoffice_rat_messages` (`user_staff_id` ASC);

CREATE INDEX `fk_lord_backoffice_rat_messages_lord_backoffice_rat_entries_idx` ON `lord`.`lord_backoffice_rat_messages` (`backoffice_rat_entry_id` ASC);
...
CREATE INDEX `fk_lord_backoffice_rattery_messages_lord_ratteries1_idx` ON `lord`.`lord_backoffice_rattery_messages` (`rattery_id` ASC);

CREATE INDEX `fk_lord_backoffice_rattery_messages_lord_users1_idx` ON `lord`.`lord_backoffice_rattery_messages` (`user_staff_id` ASC);
