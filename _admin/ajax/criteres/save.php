...
if(isset($User->connect) AND $User->connect)
{
	...
	if(!empty(filter_input(INPUT_POST,'critere',FILTER_SANITIZE_STRING)) AND !empty(filter_input(INPUT_POST,'id',FILTER_SANITIZE_STRING)) AND !empty(filter_input(INPUT_POST,'nom',FILTER_SANITIZE_STRING)))
	{
	...
	else if(!empty(filter_input(INPUT_GET,'critere',FILTER_SANITIZE_STRING)) AND !empty(filter_input(INPUT_GET,'id',FILTER_SANITIZE_STRING)) AND !empty(filter_input(INPUT_GET,'nom',FILTER_SANITIZE_STRING)))
	{
	...
	if(!is_null($params))
	{
		$critere = $Lord->saveCriteres($critere,$params)->response->datas;
