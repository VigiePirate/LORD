...
class LORDRAT_API{
	...
	{
		$datas = $this->query("rats/count",$params);
	...
	public function searchRat($params)
	{
		...
		error_log(print_r($datas->response->query,TRUE));
		
		return $datas->response->datas;
	}
	
	// Gestion du SAV
	public function addRatSavMsg($params)
	{
		$datas = $this->query("rats/sav/add",$params);
		
		return $datas->response->datas;
	}
	
	public function listRatSavMsg($params)
	{
		$datas = $this->query("rats/sav/list",$params);
		
		return $datas->response->datas;
	}
	
	public function statusRatSav($params)
	{
		$datas = $this->query("rats/sav/status",$params);
